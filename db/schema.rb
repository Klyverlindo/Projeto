...
ActiveRecord::Schema[7.0].define(version: 2023_10_06_182600) do
  ...
  create_table "visitantes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "data_hora_visita"
    t.index ["funcionario_id"], name: "index_visitantes_on_funcionario_id"
    t.index ["setor_id"], name: "index_visitantes_on_setor_id"
  end

  add_foreign_key "funcionarios", "setors"
  add_foreign_key "visitantes", "funcionarios"
